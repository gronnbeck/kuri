...
export default class extends Controller {
  ...
  addMappingRow() {
    ...
    const sourceFields = ["verb","verb_reading","verb_en","target_form","answer","answer_reading","answer_en","verb_audio","answer_audio","difficulty","notes"]
  ...
  get testConnectionPath() { return "/settings/listen/verbs/test_connection" }
  get fetchDecksPath()     { return "/settings/listen/verbs/fetch_decks" }
  get fetchNoteTypesPath() { return "/settings/listen/verbs/fetch_note_types" }
  get fetchFieldsPath()    { return "/settings/listen/verbs/fetch_fields" }
}
